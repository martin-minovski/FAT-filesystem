...
#define FATBLOCKSNEEDED (MAXBLOCKS / FATENTRYCOUNT )	//Added for convenience!
...
typedef struct filedescriptor {
   ...
   fatentry_t  blockno ;
   diskblock_t buffer ;
	int dirIndex;		//Denotes the index to the dir containing the file
	int entryNo;		//Entry no of the file in the dir
	int globalpos;		//byte within the whole entry
	int hasnext;		//If has next to read/write. Determined by filelength and pos.
} MyFILE ;
